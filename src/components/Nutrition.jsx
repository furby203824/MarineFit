...
import { Utensils, ChevronRight, ChevronLeft, ExternalLink, BookOpen, Shield, X, Download } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white m-0">
              {activeSection ? sections.find((s) => s.id === activeSection)?.title : 'Performance Nutrition'}
            </h1>
            ...
            >
              {sections.map((section, index) => (
                ...
                >
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-xs leading-relaxed">{section.desc}</p>
                </motion.div>
              ))}
            </motion.div>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-red-100 mb-4">
                    Comprehensive strategies for obtaining the cognitive and physiological edge under rigorous
                    conditions.
                  </p>
                  <a
