  ...
  const prehabExercises = [
    {
      ...
      reps: '3x15',
      url: 'https://www.dvidshub.net/video/551136/pvc-half-kneeling-hip-flexor',
    },
  ...
  const warmupProtocols = [
    {
      ...
      exercises: [
        ...
        { name: 'Inchworm', reps: '8 reps', url: 'https://www.dvidshub.net/video/551396/inchworm' },
        {
          ...
          reps: '10 each',
          url: 'https://www.dvidshub.net/video/551861/walking-lunge-with-twist',
        },
    ...
    },
    {
      ...
      exercises: [
        { name: 'Light Jog', reps: '400m', url: '' },
        {
          ...
          reps: '15 each',
          url: 'https://www.dvidshub.net/video/551823/sagittal-leg-swing',
        },
        {
          name: 'Leg Swings (Side/Side)',
          reps: '15 each',
          url: 'https://www.dvidshub.net/video/551381/frontal-leg-swing',
        },
    ...
    },
    {
      ...
      exercises: [
        { name: 'Light Jog', reps: '400m', url: '' },
        {
          name: 'Walking Lunge - Elbow to Instep',
          reps: '8 each',
          url: 'https://www.dvidshub.net/video/551857/walking-lunge-elbow-instep',
        },
              ...
              >
                ...
                {ex.url && (
                  <a
                    ...
                    className="p-2 text-gray-400 hover:text-marine-red transition-colors"
                  >
                    <PlayCircle size={24} />
                  </a>
                )}
