...
const PlankProgram = () => {
  ...
  const nextImage = () => {
    setCurrentImageIndex((prev) => (prev === plankVisuals.length - 1 ? 0 : prev + 1));
  };

  const prevImage = () => {
    setCurrentImageIndex((prev) => (prev === 0 ? plankVisuals.length - 1 : prev - 1));
  };
  ...
  return (
    <div className="space-y-6 bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[600px]">
      ...
      <div className="border-b border-gray-100 dark:border-gray-700 pb-6">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Build a bulletproof core for the PFT</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-marine-red/5 border border-marine-red/20 rounded-xl p-6">
          ...
          <p className="text-gray-700 dark:text-gray-300 font-medium text-lg">Foundation to Mastery</p>
          <p className="text-gray-600 dark:text-gray-400 text-sm mt-2">
            Follow the visual guide below for weekly progression through plank variations and core strengthening
            exercises.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="bg-gray-50 dark:bg-gray-700/50 px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() =>
                  downloadImage(plankVisuals[currentImageIndex], `Plank_Progression_Page_${currentImageIndex + 1}.jpg`)
                }
