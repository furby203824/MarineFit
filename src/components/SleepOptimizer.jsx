...
const SleepOptimizer = () => {
    ...
    categories: [
      {
        ...
        items: [
          {
            title: 'Temperature',
            desc: 'Keep room between 65-68°F (18-20°C). Core body temperature drop triggers sleep.',
          },
          {
            title: 'Darkness',
            desc: 'Use blackout curtains or eye mask. Even small light exposure suppresses melatonin by 50%.',
          },
          {
            title: 'Noise Control',
            desc: 'Use white noise or earplugs. Consistent background noise masks disruptive sounds.',
          },
          {
            title: 'Mattress & Pillow',
            desc: 'Replace mattress every 7-10 years. Pillow should support neutral spine alignment.',
          },
          {
            title: 'Clean Air',
            desc: 'Keep room ventilated. CO2 buildup impairs sleep quality and cognitive function.',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            desc: 'Start 60-90 minutes before bed. Dim lights, reduce stimulation, calm activities only.',
          },
          {
            title: 'No Screens',
            desc: 'Stop screen use 1 hour before bed. Blue light delays melatonin release by up to 3 hours.',
          },
          {
            title: 'Hot Shower/Bath',
            desc: 'Take 10-15 min before bed. The subsequent body cooling mimics natural sleep onset.',
          },
          {
            title: 'Journaling',
            desc: "Write tomorrow's tasks before bed. Reduces cognitive arousal and worry loops.",
          },
          {
            title: 'Breathing Exercise',
            desc: '4-7-8 technique: Inhale 4s, hold 7s, exhale 8s. Activates parasympathetic nervous system.',
          },
        ],
      },
      {
        ...
        items: [
          {
            title: 'Caffeine After 1400',
            desc: 'Caffeine half-life is 5-6 hours. A 1400 coffee still has 25% active at 2200.',
          },
          {
            title: 'Alcohol Before Bed',
            desc: 'Alcohol fragments sleep architecture and suppresses REM. Avoid within 3 hours of sleep.',
          },
          {
            title: 'Heavy Meals Late',
            desc: 'Large meals within 2-3 hours of bed impair sleep quality. Light snacks are OK.',
          },
          {
            title: 'Intense Exercise',
            desc: 'Avoid high-intensity training within 3 hours of bed. Elevates core temp and cortisol.',
          },
          {
            title: 'Clock Watching',
            desc: 'Turn clocks away. Checking time increases anxiety and makes falling asleep harder.',
          },
        ],
      },
    ],
  ...
  const recoveryContent = {
    ...
    debtEffects: [
      {
        debt: '1-2 hours',
        impact: 'Minor: 10-15% cognitive decline, reaction time +10%',
        training: 'Full training OK, monitor RPE',
      },
      {
        debt: '3-5 hours',
        impact: 'Moderate: 25% cognitive decline, coordination affected',
        training: 'Reduce intensity 15-20%, avoid complex skills',
      },
      {
        debt: '6-10 hours',
        impact: 'Significant: Equivalent to 0.05 BAC impairment',
        training: 'Light training only, focus on mobility/recovery',
      },
      {
        debt: '10+ hours',
        impact: 'Severe: Equivalent to 0.10 BAC, judgment impaired',
        training: 'Rest day mandatory, prioritize sleep',
      },
    ],
    recoveryRates: [
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="p-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  Align your activities with your body's natural patterns
                </p>
              </div>
            ...
            <div className="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-4 border border-orange-200 dark:border-orange-800">
              ...
              <div className="space-y-2">
                {circadianContent.lightGuidelines.map((guideline, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-center py-2 border-b border-orange-200 dark:border-orange-800 last:border-0"
                  >
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSleepDebt((prev) => ({ ...prev, targetHours: parseFloat(e.target.value) || 8 }))
                    }
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-marine-red focus:border-transparent"
                  />
                </div>
              ...
              <div
                className={`p-4 rounded-lg ${
                  (sleepDebt.targetHours - sleepDebt.hoursSlept) * 7 <= 0
                    ...
                    : (sleepDebt.targetHours - sleepDebt.hoursSlept) * 7 <= 5
                      ? 'bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800'
                      : (sleepDebt.targetHours - sleepDebt.hoursSlept) * 7 <= 10
                ...
                {recoveryContent.debtEffects.map((effect, index) => (
                  <div key={index} className="p-4">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">
                      <strong>Impact:</strong> {effect.impact}
                    </p>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      <strong>Training:</strong> {effect.training}
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border border-green-200 dark:border-green-800">
              ...
              <div className="space-y-2">
                {recoveryContent.recoveryRates.map((rate, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-center py-2 border-b border-green-200 dark:border-green-800 last:border-0"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {tacticalNappingContent.protocols.map((protocol, index) => (
                ...
                >
                  <div
                    className={`p-4 ${protocol.bg} dark:bg-opacity-20 border-b border-gray-200 dark:border-gray-700`}
                  >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white m-0">
              {activeSection ? sections.find((s) => s.id === activeSection)?.title : 'Sleep Optimizer'}
            </h1>
            ...
            >
              {sections.map((section, index) => (
                ...
                >
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">{section.desc}</p>
                </motion.div>
              ))}
            </motion.div>
                  ...
                  >
                    <div
                      className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-colors ${
                        checkedItems[`tonight-${i}`] ? 'bg-green-400 border-green-400' : 'border-indigo-400'
                      }`}
                    >
                      {checkedItems[`tonight-${i}`] && <CheckCircle2 className="w-4 h-4 text-indigo-900" />}
                    </div>
                    <span
                      className={`${checkedItems[`tonight-${i}`] ? 'text-indigo-300 line-through' : 'text-indigo-100'}`}
                    >
                      {checkItem}
                    </span>
                  </div>
