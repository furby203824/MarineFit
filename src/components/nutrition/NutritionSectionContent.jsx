...
import {
  ...
  supplementWarnings,
  supplementQuestions,
  garrisonDiningFeatures,
  energyNeeds,
  operationalRations,
  missionPlanning,
  fieldNutrientTargets,
  visualResources,
  references,
            ...
            >
              <div className="aspect-video w-full bg-gray-100 dark:bg-gray-700 relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors flex items-center justify-center">
                  <Maximize2
                    className="text-white opacity-0 group-hover:opacity-100 transform scale-75 group-hover:scale-100 transition-all drop-shadow-md"
                    size={32}
                  />
                </div>
              </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              <li className="flex items-start gap-2">
                <span className="text-marine-red">•</span>Define a single system for product identification enhancing
                Marines' ability to make healthy choices
              </li>
              <li className="flex items-start gap-2">
                <span className="text-marine-red">•</span>Provide identifiable choices - NOT to prevent options
              </li>
              <li className="flex items-start gap-2">
                <span className="text-marine-red">•</span>Empower and educate Marines on making informed fueling
                decisions
              </li>
              <li className="flex items-start gap-2">
                <span className="text-marine-red">•</span>All foods CAN fit into a performance nutrition meal plan
              </li>
            </ul>
          </div>
          ...
          <div className="bg-marine-red/10 rounded-xl p-4 border border-marine-red/20">
            <p className="text-sm text-gray-700 dark:text-gray-300 font-medium">
              <strong className="text-marine-red">Performance Nutrition Messaging:</strong> Just as the Corps teaches
              Marines to locate, close with, and destroy the enemy, USMC Fueled to Fight® empowers Marines on how to
              make informed fueling decisions to maintain high performance supporting the mission.
            </p>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Color coding requires examination of each food as a whole, including additives, degree of processing, and
              nutrient values. Evaluates: total and saturated fat, fiber, sugar, sodium, and micronutrient values
              against Military Dietary Reference Intake (MDRI).
            </p>
          </div>
        </div>
      );
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">
              Choose foods that are best for you <strong className="text-green-600">80%</strong> of the time.
              Incorporate some foods that may not be the best, but are your favorites,{' '}
              <strong className="text-yellow-600">20%</strong> of the time.
            </p>
            <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-3 border border-yellow-200 dark:border-yellow-800">
              <p className="text-sm text-yellow-800 dark:text-yellow-300">
                <strong>Critical:</strong> Marines need adequate Calories to support high-intensity training. Inadequate
                Calories can result in loss of muscle mass, loss of bone density, and increased risk of fatigue,
                illness, injuries, and poor recovery.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {macronutrients.map((macro, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`bg-white dark:bg-gray-800 rounded-xl border ${macro.border} overflow-hidden`}
                >
          ...
          <div className="bg-marine-red text-white rounded-xl p-4">
            ...
            <p className="text-red-100 text-sm">
              For maximum physical and mental performance, at every meal eat <strong>carbohydrates + protein</strong>{' '}
              and drink <strong>milk</strong>. This combination provides sustained energy, muscle support, and essential
              nutrients.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm">
              The timing of <strong>"when"</strong> nutrients are consumed is just as critical as{' '}
              <strong>"what"</strong> nutrients are consumed. Proper timing maximizes nutrient absorption, maintains
              blood glucose, and optimizes the gut microbiome's response to stress in warfighter training.
            </p>
          </div>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border border-green-200 dark:border-green-800">
            ...
            <p className="text-sm text-green-800 dark:text-green-300 mb-2">
              Immediately after exercise, when glycogen stores are low and muscle protein synthesis is suppressed, is
              the <strong>critical time</strong> to provide what the body needs.
            </p>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 mt-2">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <strong className="text-marine-red">PENS (Post-Exercise Nutrition Support):</strong> ~4:1 ratio of
                carbohydrate to protein. This is based on strong evidence from numerous studies and is recommended for
                individuals engaged in rigorous physical training.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-cyan-50 dark:bg-cyan-900/20 rounded-xl p-4 border border-cyan-200 dark:border-cyan-800">
            ...
            <p className="text-sm text-cyan-800 dark:text-cyan-300">
              By the time you feel thirsty, you may already be dehydrated. Proactive hydration is essential for maximum
              performance.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5" />
                Critical role in regulating body temperature
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5" />
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5" />
                Majority of muscle is comprised of water
              </li>
            </ul>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-4 border border-yellow-200 dark:border-yellow-800">
              <h4 className="font-semibold text-yellow-900 dark:text-yellow-300 mb-2">
                {dehydrationEffects.twoPercent.title}
              </h4>
              <p className="text-xs text-yellow-700 dark:text-yellow-400 mb-2">
                {dehydrationEffects.twoPercent.example}
              </p>
              <ul className="space-y-1">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 rounded-xl p-4 border border-red-200 dark:border-red-800">
              <h4 className="font-semibold text-red-900 dark:text-red-300 mb-2">
                {dehydrationEffects.threeFivePercent.title}
              </h4>
              <p className="text-xs text-red-700 dark:text-red-400 mb-2">
                {dehydrationEffects.threeFivePercent.example}
              </p>
              <ul className="space-y-1">
            ...
            <div className="grid grid-cols-2 divide-x divide-gray-100 dark:divide-gray-700">
              <div className="p-4">
                ...
                <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
                  {dehydrationSigns.moderate.map((s, i) => (
                    <li key={i}>• {s}</li>
                  ))}
                </ul>
              </div>
              <div className="p-4">
                ...
                <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
                  {dehydrationSigns.severe.map((s, i) => (
                    <li key={i}>• {s}</li>
                  ))}
                </ul>
              </div>
          ...
          <div className="bg-red-50 dark:bg-red-900/20 rounded-xl p-4 border border-red-200 dark:border-red-800">
            ...
            <div className="space-y-2 text-sm text-red-800 dark:text-red-300">
              <p>
                <strong>Hyponatremia:</strong> Low sodium from over-hydration. Max 12 quarts/day. USMC mess hall meals
                meet sodium requirements.
              </p>
              <p>
                <strong>Rhabdomyolysis:</strong> Rapid muscle breakdown from eccentric movements, heat, dehydration,
                over-exertion. Signs: muscle pain, weakness, swelling. Health always comes first!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
            <p className="text-sm text-emerald-800 dark:text-emerald-300">
              <strong>Food is your body's fuel.</strong> Operational rations are designed using scientific evidence to
              ensure warfighter nutritional needs are met in all environments. By providing your body with proper
              nutrition, you can improve alertness, strength, and endurance.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="p-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Extreme environmental conditions can increase energy needs
              </p>
            </div>
            <div className="grid grid-cols-2 divide-x divide-gray-100 dark:divide-gray-700">
              <div className="p-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-3 border border-amber-200 dark:border-amber-800 text-center">
              ...
              <p className="text-lg font-bold text-amber-800 dark:text-amber-300">
                {fieldNutrientTargets.cho.perLb}/lb
              </p>
          ...
          <div className="bg-marine-red text-white rounded-xl p-4">
            ...
            <div className="space-y-2">
              <a
                href="https://www.hprc-online.org/page/Combat-Rations-Database-ComRaD"
                target="_blank"
              ...
              <a
                href="https://nsrdec.army.mil/img/pdfs/OP_Rations08-22-16.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-red-100 hover:text-white"
              >
        ...
        <div className="space-y-6">
              ...
              <ol className="space-y-2">
                {supplementQuestions.map((q, i) => (
                  <li key={i} className="text-sm text-gray-600 dark:text-gray-300 flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-marine-red/10 text-marine-red font-bold text-xs flex items-center justify-center flex-shrink-0">
                      {i + 1}
                    </span>
                    {q}
                  </li>
          ...
          <div className="bg-marine-red text-white rounded-xl p-4">
            ...
            <p className="text-red-100 text-sm mb-3">
              Operation Supplement Safety maintains a list of high-risk supplements that may contain harmful or banned
              substances.
            </p>
            <a
    ...
    case 'garrison':
      return (
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <p className="text-gray-600 dark:text-gray-300 text-sm">
              Menus are intentionally designed by USMC Registered Performance Dietitians to include nutrient density and
              quality. All master menus meet Military Dietary Reference Intake (MDRI) values.
            </p>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-5 border border-gray-200 dark:border-gray-600">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              <li className="flex items-start gap-2">
                <span className="text-marine-red">•</span>iOS and Android versions available
              </li>
              <li className="flex items-start gap-2">
                <span className="text-marine-red">•</span>Search installation for connected mess hall menus
              </li>
              <li className="flex items-start gap-2">
                <span className="text-marine-red">•</span>Complete menus with nutrition facts for informed choices
              </li>
              <li className="flex items-start gap-2">
                <span className="text-marine-red">•</span>Real-time dining experience feedback
              </li>
            </ul>
          </div>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border border-green-200 dark:border-green-800">
            ...
            <p className="text-sm text-green-800 dark:text-green-300">
              No cost to Marines on essential station messing (ESM) and entitled to subsist at government expense.
              Additional portions ("seconds") offered during each dining visit.
            </p>
          </div>
        </div>
      );
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
              ...
              <a
                href="https://corp.commissaries.com/shopping/click-2-go"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
              ...
              <a
                href="https://corp.commissaries.com/healthy-living/dietitian-approved-thumb"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
              ...
              <a
                href="https://corp.commissaries.com/healthy-living/healthy-eats"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm font-medium text-yellow-600 hover:text-yellow-800 flex items-center gap-1"
              >
      ...
      return (
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-800">
            ...
            <a
              href="http://usmc-mccs.org/services/fitness/health-promotion/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm font-medium text-blue-600 hover:text-blue-800 flex items-center gap-1"
            >
