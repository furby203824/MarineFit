      ...
      >
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-red-100 text-lg md:text-xl mb-8 leading-relaxed">
            The comprehensive digital command center for Marine Corps physical readiness, health optimization, and
            combat fitness.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link
              to="/pt-coach"
              className="px-6 py-3 bg-white text-marine-red rounded-lg font-bold hover:bg-gray-100 transition-colors shadow-lg"
            >
              Generate Workout
            </Link>
            <Link
              to="/pft-prep"
              className="px-6 py-3 bg-marine-gold/20 backdrop-blur-sm text-white border border-white/20 rounded-lg font-bold hover:bg-marine-gold/30 transition-colors"
            >
              Calculate Score
            </Link>
          </div>
