...
const Footer = () => {
  ...
  return (
    <div className="mt-12 pt-6 border-t border-gray-200 dark:border-gray-700 text-center pb-8">
      ...
      <dialog
        ref={dialogRef}
        className="bg-white dark:bg-gray-800 p-0 rounded-xl shadow-2xl backdrop:bg-black/60 max-w-lg w-[90%] m-auto border border-gray-100 dark:border-gray-700"
      >
        <div className="p-6">
          ...
          <div className="space-y-6 text-left overflow-y-auto max-h-[60vh] pr-2 custom-scrollbar">
            <section>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                The content in this application, including the "Return to Run" program and workout plans, is for
                educational and informational purposes only. It is not intended as a substitute for professional medical
                advice, diagnosis, or treatment. Always seek the advice of your physician, athletic trainer, or other
            ...
            <section>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                By using this application, you agree that you are voluntarily participating in these activities and
                assume all risks of injury, illness, or death. The developers and creators of this application are not
                responsible or liable for any claim, loss, or damage resulting from the use of the information contained
                herein.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                This calculator and training tool is designed to assist Marines in preparing for the PFT and CFT. While
                every effort has been made to align with MCO 6100.13A CH-2, this application is <strong>NOT</strong> an
                official Marine Corps record system. Scores calculated here are estimates. Always verify your official
                score potential with your command.
              </p>
            </section>
          </div>
