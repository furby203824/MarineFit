export const returnToRunData = {
  ...
  intro:
    'The intent of these guidelines is to provide the athlete with a framework for return to sports activity following injury. These guidelines should not take the place of medical advice. If an athlete requires assistance, they should consult with their primary care physician, surgeon, or physical therapist.',
  ...
  phases: [
    ...
    },
    {
      ...
      description:
        'A mile run typically consists of 1500 foot contacts (750 per foot). This program integrates 470 foot contacts per leg (approx. 2/3 of a mile run). Successful completion indicates readiness for 0.5 - 0.75 mile run.',
      guidelines: [
      ...
      schedule: [
        ...
        {
          step: 'Exercise 2',
          activity: 'Two-leg ankle hops: forward/backward',
          sets: 3,
          reps: 30,
          total: '90 contacts',
        },
        ...
        {
          step: 'Exercise 5',
          activity: 'One-leg ankle hops: forward/backward',
          sets: 3,
          reps: 20,
          total: '60 contacts',
        },
    ...
    },
    {
      ...
      description:
        'Do not advance to the next step if you experience pain or soreness. Perform each step 2-3 times before advancing. Run on soft surfaces (track, trail) if possible.',
      guidelines: [
