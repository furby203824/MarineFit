...
export const fueledToFightRatings = [
  ...
  },
  {
    ...
    icon: XCircle,
    description:
      'Limit the intake of these foods because they are the highest in unhealthy fat and may decrease performance.',
  },
];
...
export const hydrationProtocol = [
  {
    ...
    amount: 'Half your body weight in fluid ounces',
    note: 'Example: 150 lbs ÷ 2 = 75 fl oz',
  },
...
export const garrisonDiningFeatures = [
  {
    ...
    desc: 'Fueled to Fight® requirement on main line for entrée, side, and vegetable',
  },
  {
    icon: Salad,
    title: 'Cold Bar',
    desc: 'Nutrient-dense items - seeds, nuts, trail mixes, yogurt parfaits, fresh fruit, vegetables',
  },
  {
    icon: Box,
    title: 'Convenience Line',
    desc: "'Engage at Will' options for carryout with healthier choices up front",
  },
...
export const sections = [
  {
    id: 'resources',
    title: 'Visual Guides',
    desc: 'Infographics and educational brochures',
    icon: ImageIcon,
    color: 'text-pink-600',
    bg: 'bg-pink-50',
  },
  {
    ...
    desc: 'USMC stoplight rating system for informed food choices',
    icon: Target,
    color: 'text-green-600',
    bg: 'bg-green-50',
  },
  {
    ...
    desc: 'Understanding carbs, protein, fat, and micronutrients',
    icon: Flame,
    color: 'text-amber-600',
    bg: 'bg-amber-50',
  },
  {
    ...
    desc: 'When to eat matters as much as what you eat',
    icon: Clock,
    color: 'text-blue-600',
    bg: 'bg-blue-50',
  },
  {
    ...
    desc: 'Critical hydration protocols for optimal performance',
    icon: Droplets,
    color: 'text-cyan-600',
    bg: 'bg-cyan-50',
  },
  {
    ...
    desc: 'Field feeding and mission nutrition planning',
    icon: Package,
  ...
  },
  {
    ...
    desc: 'Operation Supplement Safety (OPSS) guidance',
    icon: Pill,
    color: 'text-red-600',
    bg: 'bg-red-50',
  },
  {
    ...
    desc: 'Performance fueling at USMC mess halls',
    icon: Utensils,
    color: 'text-orange-600',
    bg: 'bg-orange-50',
  },
  {
    ...
    desc: 'Shop smart with dietitian-approved options',
    icon: ShoppingCart,
  ...
  },
  {
    id: 'references',
    title: 'References',
    desc: 'Official USMC orders and resources',
    icon: FileText,
    color: 'text-purple-600',
    bg: 'bg-purple-50',
  },
